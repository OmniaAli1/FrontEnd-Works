...
window.addEventListener('scroll', function(){
    console.log('scrolling on contact page');
    var arrowIcon = document.getElementById('contact-arrow-icon');
...
document.getElementById('contact-arrow-link').addEventListener('click', function(event) {
